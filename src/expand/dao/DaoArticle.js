...
// 每日一文
const toDay_url =
  'https://www.easy-mock.com/mock/5b0029ac8aca094b58bb0c9e/dev/today#!method=get';
// 随机一文
const random_url =
  'https://www.easy-mock.com/mock/5b0029ac8aca094b58bb0c9e/dev/random#!method=get';
export default {
  ...
  async hasArticleCollected({date, title, author}) {
    ...
    let existIndex = -1;
    if (collectList != null && collectList !== undefined) {
